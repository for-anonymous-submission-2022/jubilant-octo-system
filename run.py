...
ckpt_name = 'ckpt/' + str(args.batch_size) +'_' +  str(args.learning_rate) + '_' +  args.model_name_or_path.split('/')[-1] + '_' + args.train_path.split('/')[-2] + '_checkpoint.pt'  
...
for epoch in range(args.epochs):
    ...
    if os.path.isfile('result2.tsv'):
        with open('result2.tsv', 'a', newline='') as f:
        ...
        with open('result2.tsv', 'w', newline='') as f:
