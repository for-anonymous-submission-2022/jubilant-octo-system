"""
Base Algorithm from <Implicit Discourse Relation Classification: We Need to Talk about Evaluation> 
Proceedings of the 58th Annual Meeting of the Association for Computational Linguistics
@najoungkim | https://github.com/najoungkim/pdtb3

Algorithm Modified by @brucewlee
"""
...
"""
Implicit으로 돌렸을 때 각 Sense의 개수
[('Comparison.Concession', 1496), ('Comparison.Contrast', 984), ('Contingency.Cause', 5798), ('Contingency.Cause+Belief', 202), ('Contingency.Condition', 202), ('Contingency.Purpose', 1388), ('Expansion.Conjunction', 4386), ('Expansion.Equivalence', 336), ('Expansion.Instantiation', 1533), ('Expansion.Level-of-detail', 3362), ('Expansion.Manner', 829), ('Expansion.Substitution', 450), ('Temporal.Asynchronous', 1295), ('Temporal.Synchronous', 541)]
"""

SELECTED_SENSES_PDTB3 = frozenset([
    'Contingency.Cause','Contingency.Purpose','Expansion.Conjunction','Expansion.Level-of-detail',
    'Temporal.Asynchronous', 'Temporal.Synchronous', 
    'Contingency.Cause+Belief', 'Contingency.Condition', 
    'Comparison.Contrast', 'Comparison.Concession',
    'Expansion.Instantiation', 'Expansion.Equivalence',
...
def pdtb3_process_raw_sections(data_path, write_path, target_relation):
    ...
    for dirname in os.listdir(annotation_path):
        ...
        for filename in os.listdir(annotation_dir):
            ...
            lines_to_write.extend(process_file(annotation_data, text_data,
                                               dirname, filename, target_relation))
...
def main():
    #python stage2_preprocess_pdtb3.py --data_dir PDTB_3.0/data --output_dir explicit_pdtb3_xval --split L2_xval --target_relation Explicit
    ...
    parser.add_argument('--target_relation', default=None, type=str, required=True,
                        help='Type of dataset (discourse) to create. Should be one of \
    ...
    pdtb3_process_raw_sections(args.data_dir, sections_data_dir, args.target_relation)
